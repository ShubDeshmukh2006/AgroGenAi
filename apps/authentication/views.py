...
def dashboard_view(request):
    ...
    from apps.schemes.models import SchemeApplication
    
    scheme_applications_count = SchemeApplication.objects.filter(user=request.user).count()
    
    context = {
        'scheme_applications_count': scheme_applications_count,
    }
